...
const jsonDiff = async (str1, str2) => {
	const tempPath1 = path.join(process.cwd(), ".Bugbee_temp1");
	const tempPath2 = path.join(process.cwd(), ".Bugbee_temp2");
	const tempGen = path.join(process.cwd(), ".Bugbee_diff");
